...
def _fix_speed_property(block: str) -> Optional[CodeFix]:
...
def _fix_speed_method(block: str) -> Optional[CodeFix]:
...
def _fix_speed_comparison(block: str) -> Optional[CodeFix]:
...
def _fix_speed_general(block: str) -> Optional[CodeFix]:
